        ...
        "schemas": {
            ...
            "SettingsInstall": {
                ...
                "properties": {
                    ...
                    "sourceDir": {
                        "type": "string",
                        "description": "Absent when there is neither a setting nor a checkout to find."
                    },
                    "python": {
                        "type": "string"
                    }
            ...
            "SettingsManagement": {
                ...
                "properties": {
                    "tokenSet": {
                        "type": "boolean",
                        "description": "Never the token itself, which is a root password for the box."
                    },
                    "origins": {
                        "type": "array",
                        "items": {
            ...
            "SettingsEngine": {
                ...
                "properties": {
                    "keepAliveSeconds": {
                        "type": "integer",
                        "description": "Absent when the engine uses residency.keepAliveSeconds."
                    }
                }
            },
            "SettingsValues": {
                ...
                "properties": {
                    "server": {
                        "$ref": "#/components/schemas/SettingsServer"
                    },
                    "log": {
                        "$ref": "#/components/schemas/SettingsLog"
                    },
                    "residency": {
                        "$ref": "#/components/schemas/SettingsResidency"
                    },
                    "workers": {
                        "$ref": "#/components/schemas/SettingsWorkers"
                    },
                    "install": {
                        "$ref": "#/components/schemas/SettingsInstall"
                    },
                    "management": {
                        "$ref": "#/components/schemas/SettingsManagement"
                    },
                    "update": {
                    ...
                    "engines": {
                        "type": "object",
                        "additionalProperties": {
                            "$ref": "#/components/schemas/SettingsEngine"
                        },
                        "description": "One per engine in the registry."
                    }
                },
                "required": [
                    "server",
                ...
                "description": "What the running process is using. A setting waiting for a restart shows its old value here."
            },
            "SettingField": {
                "type": "object",
                "properties": {
                    "key": {
                        "type": "string",
                        "description": "Dotted: residency.keepAliveSeconds, engines.kokoro.keepAliveSeconds."
                    },
                    "source": {
                        "type": "string",
                        "enum": [
                        ...
                        "description": "The layer the value in use came from."
                    },
                    "applies": {
                        "type": "string",
                        "enum": [
                        ...
                        "description": "Whether a change takes effect when it is written."
                    },
                    "saved": {
                        "description": "A value waiting for a restart. For management.token, `true` and never the token."
                    }
                },
                "required": [
                    "key",
